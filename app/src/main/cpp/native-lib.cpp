...
Java_com_example_ios_facedetectingtest_MainActivity_detect(JNIEnv *, jobject,
...
Java_com_example_ios_facedetectingtest_MainActivity_loadCascade(JNIEnv *env, jobject,
